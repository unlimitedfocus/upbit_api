module UpbitApi
  ...
  class Public
    ...
    def market
      UpbitApi.response self.class.get('/v1/market/all', verify: true)
    end
    ...
    def candles_minutes(unit, market, count = 1, to = nil)
      UpbitApi.response self.class.get("/v1/candles/minutes/#{unit}", query: {
        market: market,
        to: to,
        count: count
      }, verify: true)
    ...
    def candles_days(market, count = 1, to = nil, converting_price_unit = nil)
      UpbitApi.response self.class.get("/v1/candles/days", query: {
        market: market,
        to: to,
        count: count,
    ...
    def candles_weeks(market, count = 1, to = nil)
      UpbitApi.response self.class.get("/v1/candles/weeks", query: {
        market: market,
        to: to,
        count: count
      }, verify: true)
    ...
    def candles_months(market, count = 1, to = nil)
      UpbitApi.response self.class.get("/v1/candles/months", query: {
        market: market,
        to: to,
        count: count
      }, verify: true)
    ...
    def trades_ticks(market, count = 1, cursor = 1, to = nil)
      UpbitApi.response self.class.get("/v1/trades/ticks", query: {
        market: market,
        to: to,
        count: count,
        cursor: cursor
    ...
    def ticker(markets)
      UpbitApi.response self.class.get("/v1/ticker", query: {
        markets: markets
      }, verify: true)
    end
    ...
    def orderbook(markets)
      UpbitApi.response self.class.get("/v1/orderbook", query: {
        markets: markets
      }, verify: true)
    end
  end
